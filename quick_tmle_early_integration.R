## ---------------------------
##
## Script name: quick_tmle_early_integration
##
## Purpose of script: configuración "rápida" para TMLE con integración temprana
##
...
##
## Notes:
## - Rutas parametrizadas para evitar rutas absolutas.
## - Ajustes de cómputo para usar menos recursos sin perder reproducibilidad.
## ---------------------------
## ------------------------------------ ##
