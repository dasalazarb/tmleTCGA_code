## ---------------------------
##
## Script name: quick_tmle_late_integration
##
## Purpose of script: pipeline TMLE "rápido" con integración tardía
##
...
##
## Notes:
## - Rutas configurables y ajustes ligeros para reducir uso de CPU.
## ---------------------------
